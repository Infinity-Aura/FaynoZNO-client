...
import { createUser, deleteUser, getUser, getUsers, updateUser, updateUserRole } from './api';
...
export const updateUserRoleFx = domain.effect(updateUserRole);
